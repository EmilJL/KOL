    ...
    return(
        <View style={{width: '100%', height: screenHeight*0.3-statusBarHeight, position: 'absolute', bottom: screenHeight*0.6, paddingLeft: '6%', paddingRight: '6%', bottom: 0, marginBottom: '15%'}}>
          <View style={{flex: 1,  marginBottom: '5%'}}>
            ...
            <TextInput autoFocus={true} onChangeText={(value) => this.handleTextInput(value, 'password')} placeholder='Indtast email' placeholderTextColor='lightgrey' style={{flex: 1, borderRadius: 5, width: '100%', borderColor: 'grey', borderWidth: 2, paddingLeft: '5%'}}/>
          </View>
